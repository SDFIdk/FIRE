...
def test_mildeste_kvalitetskrav():
    ...
    # Aliaser
    P_alias, K_alias, D_alias = (Nøjagtighed.Præcision, Nøjagtighed.Kvalitet, Nøjagtighed.Detail)
    MGL_alias, MTL_alias = (NivMetode.MotoriseretGeometriskNivellement, NivMetode.MotoriseretTrigonometriskNivellement)
