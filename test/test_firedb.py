...
def test_hent_observationer_naer_geometri(firedb):
    ...
    assert len(os) is 17
    point = "POINT (10.4811749340072 56.3061226484564)"
    os = firedb.hent_observationer_naer_geometri(point, 100)
    assert len(os) is 2
    polygon = "POLYGON ((10.4811749340072 56.3061226484564, 10.5811749340072 56.3061226484564, 10.5811749340072 56.4061226484564, 10.4811749340072 56.4061226484564, 10.4811749340072 56.3061226484564))"
